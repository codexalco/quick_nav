...
/// An implementation of [QuickNavPlatform] that uses method channels.
class MethodChannelQuickNav extends QuickNavPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('quicknav');
